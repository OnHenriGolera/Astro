 ...
 * 
 * Test the modification of participants
 * 
 * @see ParticipantCreation
 * @deprecated
 */
@Deprecated
public class ParticipantBadModification extends BadModificationTest<ParticipantEntity> {
     ...
     * Set the test name
     */
    public ParticipantBadModification() {
